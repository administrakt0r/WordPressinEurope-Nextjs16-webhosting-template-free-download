...
export const BackToTop = memo(function BackToTop() {
  ...
  return (
    <button
      ...
      title="Back to top"
      className={cn(
        "fixed bottom-8 right-8 z-50 p-2 bg-slate-950 text-white rounded-full shadow-lg hover:bg-slate-900 hover:-translate-y-1 transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-primary focus-visible:ring-offset-slate-950 group flex items-center justify-center will-animate disabled:opacity-0 disabled:translate-y-4 disabled:pointer-events-none",
        isVisible ? "opacity-100 translate-y-0 cursor-pointer" : ""
      )}
