...
export const AdvantageSection = memo(function AdvantageSection() {
    ...
    return (
        <div className="bg-blue-600 rounded-3xl p-8 md:p-12 text-white overflow-hidden relative">
            ...
            <div
                className="absolute top-0 right-0 w-64 h-64 -translate-y-1/2 translate-x-1/2 transform-gpu bg-[radial-gradient(closest-side,rgba(255,255,255,0.1),transparent)]"
            />
            <div
                className="absolute bottom-0 left-0 w-64 h-64 translate-y-1/2 -translate-x-1/2 transform-gpu bg-[radial-gradient(closest-side,rgba(250,204,21,0.2),transparent)]"
            />
