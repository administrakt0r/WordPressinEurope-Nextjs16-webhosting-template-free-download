...
export const FeatureCard = memo(function FeatureCard({ icon, title, description }: FeatureCardProps) {
    return (
        ...
        >
            <div className="w-12 h-12 rounded-xl bg-blue-900/30 text-primary flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300 ease-out will-animate">
                {icon}
            </div>
